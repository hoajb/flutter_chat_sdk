...
class ChatsMy extends StatefulWidget {
  ChatsMy({Key key}) : super(key: key);

  @override
  _ChatsMyState createState() => _ChatsMyState();
}

class _ChatsMyState extends State<ChatsMy> with TickerProviderStateMixin {
